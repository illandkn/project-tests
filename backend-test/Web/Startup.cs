...
namespace Web
{
    public class Startup : IStartup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<MainContext>(options => options.UseSqlServer(Configuration.GetConnectionString("ConnectionString")));
        ...
        public void Configure(WebApplication app, IWebHostEnvironment environment)
        {
            ...
            app.UseCors(option => option.AllowAnyHeader().AllowAnyMethod().AllowAnyOrigin().WithOrigins("http://localhost:3000"));
